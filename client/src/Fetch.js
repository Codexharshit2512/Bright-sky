...
export const fetchPlaces = async (location) => {
  try {
    const { data: result } = await axios({
      method: "POST",
      url: "https://brightskyweather.herokuapp.com/weather",
...
export const forecast = async (latitude, longitude) => {
  try {
    const { data } = await axios({
      method: "POST",
      url: "https://brightskyweather.herokuapp.com/forecast",
      headers: {
        "Content-Type": "application/json",
      },
...
export function postWeather(location, data) {
  axios({
    method: "POST",
    url: "https://brightskyweather.herokuapp.com/postWeather",
    headers: {
      "Content-Type": "application/json",
    },
...
export function loadWeather() {
  return axios({
    method: "GET",
    url: "https://brightskyweather.herokuapp.com/getWeather",
  })
